...
\title{\textbf{Future Electrical Generator Technologies for Offshore Wind Turbines}} % Subtitle

\author{\textsc{Ozan Keysan} % Author
\\{\textit{Institute for Energy  Systems\\ University of Edinburgh, UK}}} % Institution
...
\hspace*{3,6mm}\textit{Keywords:} electrical generators, direct-drive systems, permanent-magnet generators, hydraulic power take-off, superconducting generators. % Keywords
...
\begin{table}
  ...
  & DFIG & Hydraulics & DFIG & PMG & PMG & EESG \\
    ...
    \hline
   \end{tabular}
  \caption{Comparison of different power take-off systems ($\star$ represents preferred aspects).}
